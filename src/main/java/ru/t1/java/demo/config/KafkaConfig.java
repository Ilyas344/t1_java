...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerListenerFactory() {
        ...
        DefaultKafkaConsumerFactory factory = new DefaultKafkaConsumerFactory<String, Object>(props);
...
//    }
    ...
    @ConditionalOnProperty(value = "t1.kafka.producer.enable",
            havingValue = "true",
            matchIfMissing = true)
    public KafkaClientProducer producerAccount(KafkaTemplate template) {
    ...
    @ConditionalOnProperty(value = "t1.kafka.producer.enable",
            havingValue = "true",
            matchIfMissing = true)
    public KafkaClientProducer producerTransaction(KafkaTemplate template) {
